...
declare class SDK {
     ...
     */
    getCO2ForARun(body: types.GetCo2ForARunBodyParam): Promise<FetchResponse<200, types.GetCo2ForARunResponse200>>;
    /**
     ...
     */
    getCO2ForShipment(body: types.GetCo2ForShipmentBodyParam, metadata?: types.GetCo2ForShipmentMetadataParam): Promise<FetchResponse<200, types.GetCo2ForShipmentResponse200>>;
    /**
     ...
     */
    getCO2ForVessel(metadata?: types.GetCo2ForVesselMetadataParam): Promise<FetchResponse<200, types.GetCo2ForVesselResponse200>>;
    /**
     ...
     */
    getCO2ForAircraft(metadata?: types.GetCo2ForAircraftMetadataParam): Promise<FetchResponse<200, types.GetCo2ForAircraftResponse200>>;
    /**
     ...
     */
    getCO2ForInlandWater(metadata?: types.GetCo2ForInlandWaterMetadataParam): Promise<FetchResponse<200, types.GetCo2ForInlandWaterResponse200>>;
    /**
     ...
     */
    getCO2ForRail(metadata?: types.GetCo2ForRailMetadataParam): Promise<FetchResponse<200, types.GetCo2ForRailResponse200>>;
    /**
     * This endpoint returns CO2e emissions (i.e., CO2 equivalent emissions) in grams (g) for a
     ...
     */
    getCO2ForRoad(metadata?: types.GetCo2ForRoadMetadataParam): Promise<FetchResponse<200, types.GetCo2ForRoadResponse200>>;
    /**
     ...
     */
    getVesselPosition(metadata: types.GetVesselPositionMetadataParam): Promise<FetchResponse<200, types.GetVesselPositionResponse200>>;
    /**
     ...
     */
    getVesselTrace(metadata?: types.GetVesselTraceMetadataParam): Promise<FetchResponse<200, types.GetVesselTraceResponse200>>;
    /**
     ...
     */
    getWeatherTimeFrame(metadata: types.GetWeatherTimeFrameMetadataParam): Promise<FetchResponse<200, types.GetWeatherTimeFrameResponse200>>;
}
